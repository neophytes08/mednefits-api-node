...
module.exports = {
    createCompany : {
       ...
       dependentActivePlanExtensionInvoiceValidation: {
            // active_plan_extensions_id: Joi.required(),
            active_plan_extensions_id: Joi.required(),
            customer_id: Joi.required(),
            employees: Joi.required(),
       ...
       dependentActivePlanExtension: {
        ...
        businessInformationValidation: {
            ...
            contact_list: Joi.object().keys({
                add_contact_first_name: Joi.string().optional().label("Add Contact Business Contact First Name"),
                add_contact_last_name: Joi.optional().label("Add Contact Business Contact Last Name"),
                add_contact_job_title: Joi.optional().label("Add Contact Business Contact Job Title"),
                add_contact_email: Joi.optional().label("Add Contact Business Contact Email Address"),
                add_contact_phone: Joi.optional().label("Add Contact Business Phone Contact"),
                send_email_communication: Joi.optional(),
                send_email_billing: Joi.optional(),
                created_at: Joi.required(),
                updated_at: Joi.required(),
            }),
        ...
        customerPlansValidation: {
            ...
            plan_start: Joi.required(),
            duration: Joi.required(),
            duration: Joi.date().format('YYYY-MM-DD'),
            invoice_date: Joi.date().format('YYYY-MM-DD'),
    ...
    addEmployee: {
        basicValidation: {
            ...
            fullname: Joi.required().label("First name is required."),
    ...
    exportCorporateCSV: {
        download_type: Joi.required(),
        dataIndex: Joi.required(),
        column_header: Joi.required()
    },
